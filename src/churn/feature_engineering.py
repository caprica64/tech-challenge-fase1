...
Este módulo inclui funções para criar novas features, transformar
as existentes e selecionar as mais relevantes para o modelo de
previsão de churn.
"""
...
def select_notebook_features(df: pd.DataFrame) -> pd.DataFrame:
    """Seleciona as 30 colunas definidas no notebook 02
    e mantém a coluna alvo."""
